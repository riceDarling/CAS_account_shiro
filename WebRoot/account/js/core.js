...
$('.nav-input-search').typeahead({
    source: [{
            ...
            id: 'basic-tables.html',
            name: 'Basic tables'
        }, {
            id: 'editable-tables.html',
            name: 'Editable tables'
        }, {
            id: 'dynamic-tables.html',
            name: 'Dynamic tables'
        }, {
            id: 'dropzone-file-upload.html',
            name: 'Dropzone file upload'
        }, {
            id: 'multiple-file-upload.html',
            name: 'Multiple file upload'
        }, {
            id: 'form-input-masks.html',
            name: 'Form input masks'
        }, {
            id: 'form-input-masks.html',
            name: 'Input-masks'
        }, {
            id: 'form-validation.html',
